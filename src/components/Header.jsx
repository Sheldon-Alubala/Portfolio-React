...
import { brainwave, techicon } from "../assets";
    ...
    >
      ...
      >
        <a className="block w-[12rem] xl:mr-8 " href="#hero">
          <img src={techicon} width={190} height={40} alt="TechIcon" />
        </a>
        <nav
          className={`${
        ...
        <Button classNames="hidden lg:flex" href="#login">
          Sign Up
        </Button>
        <Button
          classNames="ml-auto lg:flex lg:hidden px-3 "
